...
# from Deva.modules.sql import warns_sql as warnssql
import Deva.modules.sql.blacklist_sql as blacklistsql

# from Deva.modules.sql import cust_filters_sql as filtersql
# import Deva.modules.sql.welcome_sql as welcsql
import Deva.modules.sql.locks_sql as locksql
import Deva.modules.sql.notes_sql as sql

# from Deva.modules.rules import get_rules
import Deva.modules.sql.rules_sql as rulessql
from Deva import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from Deva.__main__ import DATA_IMPORT
from Deva.modules.connection import connected
from Deva.modules.helper_funcs.alternate import typing_action
from Deva.modules.helper_funcs.chat_status import user_admin
from Deva.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Deva{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Deva{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Deva-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Deva{}.backup".format(chat_id))  # Cleaning file
