...
import Deva.modules.sql.global_bans_sql as sql
from Deva import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Deva.modules.helper_funcs.misc import send_to_list
from Deva.modules.sql.users_sql import get_user_com_chats
