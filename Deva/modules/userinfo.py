...
import Deva.modules.sql.userinfo_sql as sql
from Deva import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Deva.__main__ import STATS, TOKEN, USER_INFO
from Deva.modules.disable import DisableAbleCommandHandler
from Deva.modules.helper_funcs.chat_status import sudo_plus
from Deva.modules.helper_funcs.extraction import extract_user
from Deva.modules.sql.global_bans_sql import is_user_gbanned
from Deva.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/TFW_UPDATES/7"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/TFW_UPDATES/8"
                            ),
                        ],
                    ]
                ),
