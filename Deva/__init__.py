...
if ENV:
    ...
    from Deva.config import Development as Config
...
pbot = Client("Deva", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from Deva.modules.helper_funcs.handlers import (
